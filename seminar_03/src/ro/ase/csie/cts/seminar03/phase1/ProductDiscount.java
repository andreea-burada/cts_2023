package ro.ase.csie.cts.seminar03.phase1;
public class ProductDiscount {
    public float GetPriceWithDiscount(ProductType productType, float productPrice, int userAccountAge)
    {
        ...
        float finalPrice = 0;
        float userBonusDiscount = (userAccountAge > minAccountAge) ? maxUserBonus : (float)userAccountAge / 100;
